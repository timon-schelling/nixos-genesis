...

{
  ...
  config = (builtins.trace (lib.util.modules.mkIfAnyUser opts (_: user: user.desktops.hyprhot.enable)) (lib.util.modules.mkIfAnyUser opts (_: user: user.desktops.hyprhot.enable))) (
    {
      programs.hyprland = {
        enable = true;
